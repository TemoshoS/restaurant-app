  ...
  function MainStack() {
    return (
      <Stack.Navigator initialRouteName='Restaurants'>
        ...
        <Stack.Screen name='RestaurantDetailsScreen' component={RestaurantDetailsScreen} options={{ headerShown: true }} />
        <Stack.Screen name='Menu' component={MenuScreen} options={{ headerShown: true }} />
        {!isAdmin && (
        <Stack.Screen name='ReservationScreen' component={ReservationScreen} options={{ headerShown: true }} />
      )}
