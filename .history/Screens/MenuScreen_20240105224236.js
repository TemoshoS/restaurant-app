...
const MenuScreen = ({ route }) => {
  ...
  const {goToReservation ,goBack}= useNavigation();
  const numColumns = 2;
  ...
  <TouchableOpacity
    style={[
      styles.categoryButton,
      selectedCategory === 'appetizer' && styles.selectedCategoryButton,
    ]}
  ...
  <TouchableOpacity
    style={[
      styles.categoryButton,
      selectedCategory === 'main course' && styles.selectedCategoryButton,
    ]}
