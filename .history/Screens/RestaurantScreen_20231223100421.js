...
const RestaurantScreen = ({ restaurants, fetchRestaurants, navigation }) => {
  ...
  const handleAdd = async () => {
    try {
      ...
      if (!newRestaurantData.restName || !newRestaurantData.restLocation || !newRestaurantData.restInfo || !newRestaurantData.restPhone|| !newRestaurantData.restWebsite || !newRestaurantData.restImage) {
        alert('Please fill in all required fields.');
        return;
      }
