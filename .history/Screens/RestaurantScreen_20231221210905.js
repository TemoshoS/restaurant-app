        ...
        renderItem={({ item }) => (
          <View style={styles.restaurantItem}>
            ...
            <View style={styles.restaurantInfo}>
              ...
              {Array.from({ length: Math.floor(item.ratings) }).map((_, index) => (
            <Ionicons key={index} name="star" size={16} color="black" />
          ))}
          {item.ratings % 1 !== 0 && (
            <Ionicons key="half" name="star-half" size={16} color="orange" />
          )}
                {/* Ratings icons */}
