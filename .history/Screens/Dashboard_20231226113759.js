  ...
  <ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.orderList}>
      ...
      <View style={styles.tableRow}>
        ...
        <Text style={styles.tableHeader}>Guests</Text>
        <Text style={styles.tableHeader}>Occasion</Text>
      ...
      {pendingOrders.map((order) => (
        <View key={order.id} style={styles.tableRow}>
          <Text style={styles.tableData}>{order.fullName}</Text>
          <Text style={styles.tableData}>{order.numOfGuests}</Text>
          <Text style={styles.tableData}>{order.occasion}</Text>
          <Text style={styles.tableData}>{order.email}</Text>
          <Text style={styles.tableData}>{order.phone}</Text>
          <Text style={[styles.tableData, styles.orderStatus]}>{order.status}</Text>
