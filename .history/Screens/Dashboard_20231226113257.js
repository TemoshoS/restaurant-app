    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.orderList}>
        <View style={styles.orderCard}>
          <Text style={styles.orderInfoHeader}>Name</Text>
          <Text style={styles.orderInfoHeader}>Guests</Text>
          <Text style={styles.orderInfoHeader}>Occasion</Text>
          <Text style={styles.orderInfoHeader}>Email</Text>
          <Text style={styles.orderInfoHeader}>Phone</Text>
          <Text style={styles.orderInfoHeader}>Status</Text>
        </View>
