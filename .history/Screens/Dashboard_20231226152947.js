...
<TouchableOpacity
  ...
  onPress={() => {
    if (!showRejectionInput) {
      // If the rejection input is not visible, show it
      setShowRejectionInput(true);
    } else {
      // If the rejection input is visible, handle rejection
      handleRejectOrder();
      setShowRejectionInput(false); // Hide the rejection input field after rejection
    }
  }}
>
  <Text style={styles.buttonText}>
    {showRejectionInput ? 'Reject Order' : 'Add Rejection Message'}
  </Text>
</TouchableOpacity>
