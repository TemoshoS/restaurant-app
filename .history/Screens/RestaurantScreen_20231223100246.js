...
const RestaurantScreen = ({ restaurants, fetchRestaurants, navigation }) => {
  ...
  const handleAdd = async () => {
    try {
      ...
      if (!newRestaurantData.restName || !newRestaurantData.restLocation || !newRestaurantData.restLocation || !newRestaurantData.restLocation|| !newRestaurantData.restLocation) {
