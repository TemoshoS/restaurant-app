...
export default function App() {
  ...
  function MainStack() {
    return (
      <Stack.Navigator initialRouteName='Restaurants'>
        ...
        <Stack.Screen name='Restaurant info' component={RestaurantDetailsScreen} options={{ headerShown: true }} />
        <Stack.Screen name='Menu' component={MenuScreen} options={{
    headerShown: true,
    headerStyle: {
      backgroundColor: '#83764F', // Background color of the header
    },
    headerTitle: 'Menu', // Title of the header
    headerTitleStyle: {
      color: '#F3EEEA', // Color of the header title
      fontWeight: 'bold', // Font weight of the header title
      fontSize: 18, // Font size of the header title
    },
    headerTintColor: '#F3EEEA', // Color of the back button and header title
  ...
  function TabNavigator() {
    return (
      <Tab.Navigator
        tabBarOptions={{
          activeTintColor: '#F3EEEA',
          inactiveTintColor: '#83764F',
        }}
      >
        <Tab.Screen
          name="home"
